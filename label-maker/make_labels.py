...
def read_rows(xlsx_path):
    ...
    for r in range(5, 5 + COLS * ROWS):     # input rows B5:B12
        ...
        # prefer the Reference tab lookup, fall back to Excel's cached value
        desc = desc_by_sku.get(sku) or str(ws.cell(r, 5).value or "").strip()
